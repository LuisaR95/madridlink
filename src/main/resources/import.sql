...
INSERT INTO documentos (id, nombre, descripcion, tipo, costo, obligatorio, marcado, tramite_id) VALUES (1, 'Modelo EX-15', 'Formulario oficial de solicitud', 'Original y Copia', 'Gratis', true, false, 1);
INSERT INTO documentos (id, nombre, descripcion, tipo, costo, obligatorio, marcado, tramite_id) VALUES (2, 'Pasaporte Completo', 'Todas las páginas', 'Fotocopia', 'Variable', true, false, 1);
...
INSERT INTO documentos (id, nombre, descripcion, tipo, costo, obligatorio, marcado, tramite_id) VALUES (4, 'DNI/Pasaporte', 'Original en vigor', 'Original', 'Gratis', true, false, 2);
INSERT INTO documentos (id, nombre, descripcion, tipo, costo, obligatorio, marcado, tramite_id) VALUES (5, 'Contrato Alquiler', 'O autorización del dueño', 'Copia', 'Gratis', true, false, 2);

-- 5. DOCUMENTOS PARA ABONO TRANSPORTE (Trámite 3)
INSERT INTO documentos (id, nombre, descripcion, tipo, costo, obligatorio, marcado, tramite_id) VALUES (6, 'Fotografía reciente', 'Tamaño carné color', 'Original', '5.00€', true, false, 3);
